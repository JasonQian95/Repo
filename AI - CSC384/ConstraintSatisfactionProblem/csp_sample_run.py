...
solve_nQueens(8, 'BT', ord_mrv, val_lcv)
print("=======================================================")
print("Plain Bactracking on 8-queens w/DH & LCV")
solve_nQueens(8, 'BT', ord_dh, val_lcv)
print("=======================================================")
print("Plain Bactracking on 8-queens w/Custom & LCV")
solve_nQueens(8, 'BT', ord_custom, val_lcv)
print("=======================================================")
