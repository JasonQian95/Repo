 ...
 * "1.0.2"], the function answer(l) would return the list ["1.0", "1.0.2",
 * "1.0.12", "1.1.2", "1.3.3"]. If two or more versions are equivalent but one
 * version contains more numbers than the others, then these versions must be
 * sorted ascending based on how many numbers they have, e.g ["1", "1.0",
 * "1.0.0"]. The number of elements in the list l will be at least 1 and will
 * not exceed 100.
 ***/
...
public class Answer2 {
	...
	public static String[] answer(String[] l) {
		Arrays.sort(l, new Comparator<String>() {
			public int compare(String str1, String str2) {
				...
				for (int i = 0; i < 3; i++) {
					int str1partI = Integer.parseInt(str1parts[i]);
					int str2partI = Integer.parseInt(str2parts[i]);
					if (str1partI < str2partI) {
						return -1;
					}
					if (str1partI > str2partI) {
						return 1;
					...
					if (i == str1parts.length - 1 && i != str2parts.length - 1) {
						return -1;
					}
					if (i != str1parts.length - 1 && i == str2parts.length - 1) {
						return 1;
	...
	public static void main(String[] args) {
		String[] in1 = { "1.1.2", "1.0", "1.3.3", "1.0.12", "1.0.2" };
		String[] out1 = { "1.0", "1.0.2", "1.0.12", "1.1.2", "1.3.3" };
		System.out.println(Arrays.equals(answer(in1), out1));

		String[] in2 = { "1.11", "2.0.0", "1.2", "2", "0.1", "1.2.1", "1.1.1", "2.0" };
		String[] out2 = { "0.1", "1.1.1", "1.2", "1.2.1", "1.11", "2", "2.0", "2.0.0" };
		System.out.println(Arrays.equals(answer(in2), out2));
